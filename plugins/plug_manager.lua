...
download_file('https://github.com/MEMO910/M_EMO/master/inc/BOT.lua','./inc/BOT.lua')
download_file('https://github.com/MEMO910/M_EMO/master/inc/functions.lua','./inc/functions.lua')
download_file('https://github.com/MEMO910/M_EMO/master/inc/locks.lua','./inc/locks.lua')
download_file('https://github.com/MEMO910/M_EMO/master/plugins/cmd_help.lua','./plugins/cmd_help.lua')
download_file('https://github.com/MEMO910/M_EMO/master/plugins/plug_manager.lua','./plugins/plug_manager.lua')
download_file('https://github.com/MEMO910/M_EMO/master/plugins/proc_msgs.lua','./plugins/proc_msgs.lua')
download_file('https://github.com/MEMO910/M_EMO/master/plugins/rdod_bot.lua','./plugins/rdod_bot.lua')
download_file('https://github.com/MEMO910/M_EMO/master/plugins/super_group.lua','./plugins/super_group.lua')
