...
local inline = {{{text="قنآه آلسـورس : ميمو 🍃",url="t.me/DEV_1IRAQ"}}}
return send_inline_key(msg.from.id,'  [قناة السورس : ميمو](t.me/DEV_1IRAQ)',nil,inline)
end
...
elseif is_mod(msg) then return   " اكل خرا هوة انتة خلك ادمن ترة انزلك😏"
else return   "اكل خرا انته لاتندفر 😏"
end end end  end
return {
patterns = {
"^("..BOT_NAME.." اتفل)(.*)$", 
